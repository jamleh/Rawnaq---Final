    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Child', 'Child'), ('Men', 'Men'), ('Womem', 'Womem'), ('Accessories', 'Accessories')], max_length=20)),
                ('label', models.CharField(choices=[('S', 'small'), ('L', 'large'), ('M', 'Medium'), ('Xl', 'Xlarge')], max_length=20)),
                ('slug', models.SlugField()),
                ('description', models.TextField()),
                ('image', models.ImageField(upload_to='')),
                ('image1', models.ImageField(default='01.png', upload_to='')),
                ('image2', models.ImageField(default='01.png', upload_to='')),
            ],
        ),
        migrations.CreateModel(
            name='ItemVariation',
